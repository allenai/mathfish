'''
Utils for generating using prompt format, taken from: 

https://github.com/allenai/open-instruct/blob/main/eval/utils.py
...
# from edreports.modelWrappers.dispatch_openai_requests import dispatch_openai_chat_requesets, dispatch_openai_prompt_requesets
import warnings
...
# # from: https://github.com/allenai/OE-Safety/blob/d997a8a0453f642e4120a7ffcb0b504ae9fbe07f/evaluation/harmbench/baselines/model_utils.py#L164
# MIXTRAL_PROMPT = {
...
#     if chat_template == "mistral" or chat_template == "mixtral":
#         TEMPLATE = MISTRAL_PROMPT
#     if chat_template == "tulu2":
